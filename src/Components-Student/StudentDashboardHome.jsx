...
const StudentDashboardHome = () => {
    ...
    const sidebar =[
        ...
        {title:"Training" , icon:UsermanageIC, Active :UsermanageAct},
        {title:"Applications" , icon:BatchesIC, Active :BatchesAct},
        {title:"Assessments" , icon:SessionsIC, Active :SessionsAct},
        {title:"Job Opportunities" , icon:Profile, Active :ProfileAct},
        {title:"Offers" , icon:SupportIC, Active :SupportAct},
        {title:"Interviews" , icon:Certificates, Active :CertificatesAct},
        {title:"Reports" , icon:ReportsIC, Active :ReportsAct},
